...
const findRidesModel = require('../model/findRidesModel');


function findRides(req, res) 
{
    var status ;
    var value = {} ;
    ...
    */
    ...
    value.origin = req.body.origin
    value.destination = req.body.destination
    value.avalable_seats = req.body.avalable_seats
    value.vehicle_brand = req.body.vehicle_brand
    ...
    {
        findRidesModel.findRides(value, function (err, result) 
        {
